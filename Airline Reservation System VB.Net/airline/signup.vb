...
Public Class signup
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        If TextBox1.Text = "Match" Then
            Try
                Dim connection1 As New SqlConnection("Data Source=.\SQLEXPRESS;AttachDbFilename=D:\airline\airline\AirlineReservationSystem.mdf;Integrated Security=True;Connect Timeout=30;User Instance=True")
                connection1.Open()
